        ...
        addressTable = $('#addressTable').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <button class="btn btn-sm btn-phoenix-secondary me-1" onclick="editAddress(${row.id})" title="수정">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-phoenix-danger" onclick="deleteAddress(${row.id})" title="삭제">
