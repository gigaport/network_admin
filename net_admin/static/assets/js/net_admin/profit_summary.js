        ...
        profitTable = $('#profitTable').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                var grandRow = '<tr class="grand-total-row" style="background: #1e293b !important; pointer-events: none;">' +
                    ...
                    '<td class="text-end py-2 align-middle" style="font-weight: 700; color: #93c5fd;">' + tOrd.toLocaleString() + '원</td>' +
                    '<td class="text-end py-2 align-middle" style="font-weight: 700; color: #fcd34d;">' + tMpr.toLocaleString() + '원</td>' +
